...
public class WsrResourceAddressFactorySpi extends WsResourceAddressFactorySpi {

    public static final String SCHEME_NAME = "wsr";
    
    static final String PROTOCOL_NAME = "wsr/1.0";
