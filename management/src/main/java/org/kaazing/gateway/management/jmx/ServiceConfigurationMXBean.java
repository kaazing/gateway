...
public interface ServiceConfigurationMXBean {
    ...
    /**
     * Return the current connects as a string. If connects are legal but none has as yet been defined, return "". If the service
     * does not even support having connects (e.g. Stomp JMS allows 0 connects), return null.
     */
    String getConnects();

    /**
     * Return the current connect options as a string. If connects are legal but none has as yet been defined, return "". If the
     * service does not even support having connects (e.g. Stomp JMS allows 0 connects), return null.
     */
