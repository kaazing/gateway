 ...
 */
package org.kaazing.gateway.management.monitoring;
    ...
    private GatewayRule gateway = new GatewayRule() {
        {
            ...
            GatewayConfiguration configuration =
                    new GatewayConfigurationBuilder()
                        .property(InternalSystemProperty.AGRONA_ENABLED.getPropertyName(), "true")
                        .property(InternalSystemProperty.GATEWAY_IDENTIFIER.getPropertyName(), "testGatewayId")
                        .service()
                            .accept(WS_URI)
                            .type("echo")
