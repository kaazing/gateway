...
public class JvmManagementBeanImplTest {
    ...
    @Test
    public void testJvmSummaryDataLimit() throws JSONException{
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(managementContext).getJvmSummaryDataGatherInterval();
        ...
        JvmManagementBeanImpl jvmManagementBeanImpl = new JvmManagementBeanImpl(gateway, SUMMARY_DATA_LIMIT);
        jvmManagementBeanImpl.gatherStats();
        String summaryData = jvmManagementBeanImpl.getSummaryData();
