...
public class NioSocketChannelIoConnectorTest {
    ...
    public void transportNameShouldBeTcp() throws Exception {
        ...
        NioSocketChannelIoConnector connector = new NioSocketChannelIoConnector(sessionConfig);
        assertEquals("tcp", connector.getTransportMetadata().getName());
    }
