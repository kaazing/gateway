...
public class WsrSslResourceAddressFactorySpiTest {

    private WsrSslResourceAddressFactorySpi addressFactorySpi;
    private URI addressURI;
    private Map<String, Object> options;
    
    @Before
    public void before() {
        addressFactorySpi = new WsrSslResourceAddressFactorySpi();
        addressURI = URI.create("wsr+ssl://localhost:2020/");
        options = new HashMap<>();
    ...
    @Test
    public void shouldHaveWsrSslSchemeName() throws Exception {
        assertEquals("wsr+ssl", addressFactorySpi.getSchemeName());
    }

    @Test (expected = IllegalArgumentException.class)
    public void shouldRequireWsrSslSchemeName() throws Exception {
        addressFactorySpi.newResourceAddress(URI.create("test://opaque"));
    }

    @Test (expected = IllegalArgumentException.class)
    public void shouldRequireExplicitPath() throws Exception {
        addressFactorySpi.newResourceAddress(URI.create("wsr+ssl://localhost:80"));
    }

    @Test 
    public void shouldNotRequireExplicitPort() throws Exception {
        ResourceAddress address = addressFactorySpi.newResourceAddress(URI.create("wsr+ssl://localhost/"));
