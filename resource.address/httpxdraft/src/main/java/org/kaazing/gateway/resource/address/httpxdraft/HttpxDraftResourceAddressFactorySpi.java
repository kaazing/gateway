...
public class HttpxDraftResourceAddressFactorySpi extends HttpResourceAddressFactorySpi {

    private static final String SCHEME_NAME = "httpx-draft";
    private static final ResourceFactory TRANSPORT_FACTORY = changeSchemeOnly("ws-draft");
