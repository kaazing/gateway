...
public class SseHttpxeSslResourceAddressFactorySpi extends SseHttpxeResourceAddressFactorySpi {
    ...
    static final ResourceFactory SSE_HTTPXE_RESOURCE_FACTORY = changeSchemeOnly(SCHEME_NAME);

    private static final ResourceFactory TRANSPORT_FACTORY = changeSchemeOnly("httpxe+ssl");
