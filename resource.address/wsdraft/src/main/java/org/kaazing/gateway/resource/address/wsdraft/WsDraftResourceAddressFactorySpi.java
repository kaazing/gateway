...
public class WsDraftResourceAddressFactorySpi extends WsResourceAddressFactorySpi {

    public static final String SCHEME_NAME = "ws-draft";
    public static final String DRAFT_75_SCHEME_NAME = "ws-draft-75";
