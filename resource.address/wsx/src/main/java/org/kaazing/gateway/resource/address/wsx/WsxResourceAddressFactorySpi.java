...
public class WsxResourceAddressFactorySpi extends WsResourceAddressFactorySpi {

    public static final String SCHEME_NAME = "wsx";
    
    private static final ResourceFactory TRANSPORT_FACTORY = changeSchemeOnly("httpx");
    ...
    protected void setOptions(WsResourceAddress address, ResourceOptions options, Object qualifier) {
        ...
        options.setOption(WsResourceAddress.CODEC_REQUIRED, Boolean.FALSE);
