...
public class FindMatchingAuthConstraint extends AbstractVisitor {
    ...
    public FindMatchingAuthConstraint() {
        super();
    }
    ...
    public void visit(Element element) throws Exception {
        ...
        if (typeElement != null) {
            if (element.getChildren(CONSTRAINT, namespace) == null && element.getChildren(AUTH_CONSTRAINT, namespace) == null) {
                return;
            }
        }   
    }
