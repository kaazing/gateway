...
import org.kaazing.gateway.server.config.mar2016.AuthenticationType;
import org.kaazing.gateway.server.config.mar2016.AuthenticationType.AuthorizationMode;
import org.kaazing.gateway.server.config.mar2016.AuthenticationType.HttpChallengeScheme;
import org.kaazing.gateway.server.config.mar2016.AuthorizationConstraintType;
import org.kaazing.gateway.server.config.mar2016.ClusterConnectOptionsType;
import org.kaazing.gateway.server.config.mar2016.ClusterType;
import org.kaazing.gateway.server.config.mar2016.CrossSiteConstraintType;
import org.kaazing.gateway.server.config.mar2016.GatewayConfigDocument;
import org.kaazing.gateway.server.config.mar2016.GatewayConfigDocument.GatewayConfig;
import org.kaazing.gateway.server.config.mar2016.LoginModuleOptionsType;
import org.kaazing.gateway.server.config.mar2016.LoginModuleType;
import org.kaazing.gateway.server.config.mar2016.LoginModulesType;
import org.kaazing.gateway.server.config.mar2016.MimeMappingType;
import org.kaazing.gateway.server.config.mar2016.RealmType;
import org.kaazing.gateway.server.config.mar2016.SecurityStoreType;
import org.kaazing.gateway.server.config.mar2016.SecurityStoreType.Type;
import org.kaazing.gateway.server.config.mar2016.SecurityType;
...
import org.kaazing.gateway.server.config.mar2016.ServiceDefaultsType;
import org.kaazing.gateway.server.config.mar2016.ServicePropertiesType;
import org.kaazing.gateway.server.config.mar2016.ServiceType;
import org.kaazing.gateway.server.config.mar2016.SuccessType;
