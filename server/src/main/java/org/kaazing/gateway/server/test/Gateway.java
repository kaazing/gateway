...
import org.kaazing.gateway.server.config.mar2015.AuthenticationType;
import org.kaazing.gateway.server.config.mar2015.AuthenticationType.AuthorizationMode;
import org.kaazing.gateway.server.config.mar2015.AuthenticationType.HttpChallengeScheme;
import org.kaazing.gateway.server.config.mar2015.AuthorizationConstraintType;
import org.kaazing.gateway.server.config.mar2015.ClusterConnectOptionsType;
import org.kaazing.gateway.server.config.mar2015.ClusterType;
import org.kaazing.gateway.server.config.mar2015.CrossSiteConstraintType;
import org.kaazing.gateway.server.config.mar2015.GatewayConfigDocument;
import org.kaazing.gateway.server.config.mar2015.GatewayConfigDocument.GatewayConfig;
import org.kaazing.gateway.server.config.mar2015.LoginModuleOptionsType;
import org.kaazing.gateway.server.config.mar2015.LoginModuleType;
import org.kaazing.gateway.server.config.mar2015.LoginModulesType;
import org.kaazing.gateway.server.config.mar2015.MimeMappingType;
import org.kaazing.gateway.server.config.mar2015.RealmType;
import org.kaazing.gateway.server.config.mar2015.SecurityStoreType;
import org.kaazing.gateway.server.config.mar2015.SecurityStoreType.Type;
...
import org.kaazing.gateway.server.config.mar2015.ServicePropertiesType;
import org.kaazing.gateway.server.config.mar2015.ServiceType;
import org.kaazing.gateway.server.config.mar2015.SuccessType;
