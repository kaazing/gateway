            ...
            GatewayConfiguration configuration =
                    new GatewayConfigurationBuilder()
                        .service()
                         ...
                         .done()
                         .service()
                            .accept(URI.create("http://localhost:8009/"))
                            .connect(URI.create("http://localhost:8010/"))
                            .property("use-forwarded", "inject")
                            .type("http.proxy")
                            .connectOption("http.keepalive", "disabled")
                         .done()
                         .service()
                            .accept(URI.create("http://localhost:8010/"))
                            .connect(URI.create("http://localhost:8111/"))
                            .property("use-forwarded", "exclude")
                            .type("http.proxy")
                            .connectOption("http.keepalive", "disabled")
                          .done()
                         .service()
                            .accept(URI.create("http://localhost:8111/"))
                            .connect(URI.create("http://localhost:8112/"))
                            .type("http.proxy")
                            .connectOption("http.keepalive", "disabled")
                         .done()
                         .service()
                            .accept(URI.create("http://localhost:8112/"))
                            .connect(URI.create("http://localhost:8113/"))
                            .property("use-forwarded", "inject")
                            .type("http.proxy")
                            .connectOption("http.keepalive", "disabled")
                         .done()
                         .service()
                            .accept(URI.create("http://localhost:8113/"))
                            .connect(URI.create("http://localhost:8081/"))
                            .type("http.proxy")
                            .property("use-forwarded", "inject")
                            .connectOption("http.keepalive", "disabled")
                        .done()
