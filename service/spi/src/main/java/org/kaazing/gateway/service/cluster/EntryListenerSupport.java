...
public class EntryListenerSupport<K, V>  extends EntryAdapter {
    private List<MapListener> listenerEntries;
    ...
    public void addEntryListener(EntryListener<K, V> listener, K key, boolean includeValue) {
        listenerEntries.add(new MapListener<>(listener, key, includeValue));
    }
    ...
    public boolean removeEntryListener(String listener) {
       return listenerEntries.remove(listener);
    }
