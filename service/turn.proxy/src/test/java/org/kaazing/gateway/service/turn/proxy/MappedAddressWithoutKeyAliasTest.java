...
public class MappedAddressWithoutKeyAliasTest {

    @Rule
    public TestRule testExecutionTrace = new MethodExecutionTrace();
    
    @Test
    public void shouldFailGatewayStartupWhenMappedAddressSetWithoutKeyAlias() throws Exception {
        ...
        try {
            ...
            throw new AssertionError("Gateway should fail to start because key alias is not defined.");
        } catch (TurnProxyException e) {
