...
public abstract class AbstractChannelIoAcceptor<C extends IoSessionConfig, F extends ChannelFactory, A extends SocketAddress> extends AbstractIoAcceptor implements ChannelIoService {

	private final ServerBootstrap bootstrap;
	private final Map<SocketAddress, Channel> boundChannels;
	private final IoAcceptorChannelHandler parentHandler;
	
	public AbstractChannelIoAcceptor(C sessionConfig, F channelFactory) {
		...
		parentHandler = new IoAcceptorChannelHandler(this);
