...
public abstract class AbstractChannelIoConnector<C extends IoSessionConfig, F extends ChannelFactory, A extends SocketAddress> extends AbstractIoConnector implements ChannelIoService {

	private final F channelFactory;
	private ChannelPipelineFactory pipelineFactory;

	public AbstractChannelIoConnector(C sessionConfig, F channelFactory) {
