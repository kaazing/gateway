...
public class AbstractChannelIoSessionConfig<T extends ChannelConfig> extends AbstractIoSessionConfig {

	protected final T channelConfig;
	
	public AbstractChannelIoSessionConfig(T channelConfig) {
