...
/**
 * Superclass for all the beans that generate summary data on a timed interval and
 * send that data out to summaryDataListeners, which can then send it out.
 */
public abstract class AbstractManagementBean implements ManagementBean {
    ...
    public void scheduleSummaryData() {
