 ...
 * 
 * For this strategy, we just collect stats at the service level and do NOTHING at the
 * session level, including creating session-management beans.
 * 
 * Note that for the filter strategy, Service processing is the same between service-collect-only
 * and service-full. Those are handled at the service level.
 * 
...
public class ServiceOnlyManagementFilterStrategy extends PassThruManagementFilterStrategy {    
    ...
    public void doSessionCreated(ManagementContext managementContext,
        ...
        managementContext.getManagementGatewayStrategy().doSessionCreated(serviceBean.getGatewayManagementBean(), sessionId, managementSessionType);
    ...
    public void doSessionClosed(ManagementContext managementContext, 
        ...
        managementContext.getManagementGatewayStrategy().doSessionClosed(serviceBean.getGatewayManagementBean(), sessionId, managementSessionType);
    ...
    public void doMessageReceived(ManagementContext managementContext,
        ...
        managementContext.getManagementGatewayStrategy().doMessageReceived(serviceBean.getGatewayManagementBean(), sessionId, sessionReadBytes, message);
    ...
    public void doFilterWrite(ManagementContext managementContext,
        ...
        managementContext.getManagementServiceStrategy().doFilterWrite(serviceBean, sessionId, sessionWrittenBytes, writeRequest);
        managementContext.getManagementGatewayStrategy().doFilterWrite(serviceBean.getGatewayManagementBean(), sessionId, sessionWrittenBytes, writeRequest);
    ...
    public void doExceptionCaught(ManagementContext managementContext,
        ...
        managementContext.getManagementGatewayStrategy().doExceptionCaught(serviceBean.getGatewayManagementBean(), sessionId, cause);
