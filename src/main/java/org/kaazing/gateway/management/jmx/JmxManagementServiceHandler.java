...
class JmxManagementServiceHandler implements ManagementServiceHandler  {
    ...
    public void addServiceConfigurationBean(ServiceConfigurationBean serviceConfigurationBean) {
        try {
            ...
            if (mbeanServer.isRegistered(name)) {
                ...
                ServiceConfigurationMXBean serviceConfigurationMXBean = new ServiceConfigurationMXBeanImpl(name, serviceConfigurationBean);
    ...
    public void cleanupRegisteredBeans() {
        ...
        // These query strings are tied to the constants at the top of the file and are sensitive to changes in those format strings
