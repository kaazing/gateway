...
public interface HostManagementBean extends SystemManagementBean {
    ...
    public static String[] SUMMARY_DATA_FIELD_LIST = 
            new String[] {"osName", "uptimeSeconds", 
                          ...
                          "cpuPercentage"};
    public static int SUMMARY_DATA_OS_NAME_INDEX = 0;
    public static int SUMMARY_DATA_UPTIME_SECONDS_INDEX = 1;
    public static int SUMMARY_DATA_TOTAL_FREE_MEMORY_INDEX = 2;
    public static int SUMMARY_DATA_TOTAL_USED_MEMORY_INDEX = 3;
    public static int SUMMARY_DATA_TOTAL_MEMORY_INDEX = 4;
    public static int SUMMARY_DATA_TOTAL_FREE_SWAP_INDEX = 5;
    public static int SUMMARY_DATA_TOTAL_USED_SWAP_INDEX = 6;
    public static int SUMMARY_DATA_TOTAL_SWAP_INDEX = 7;
    public static int SUMMARY_DATA_CPU_PERCENTAGE_INDEX = 8;
