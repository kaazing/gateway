 ...
 * protocols (e.g., JMX, SNMP) for the list of NIC management beans. This is primarily here
 * because we want to have a separate summary set of data for the list of NIC data, not
 * mix with CPU/core or more common system information.
 */
