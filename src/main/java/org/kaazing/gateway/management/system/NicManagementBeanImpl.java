...
//    private static final AtomicInteger maxServiceIndex = new AtomicInteger(1);
    ...
    private double rxBytesPerSecond = 0.0;
    
    private double txBytesPerSecond = 0.0;
    ...
    public String getSummaryData() {
        ...
        try {
            ...
            jsonObj.put(SUMMARY_DATA_FIELD_LIST[SUMMARY_DATA_RXBYTESPERSECOND_INDEX], roundTo(getRxBytesPerSecond(), ROUND_TO_PLACES));
            ...
            jsonObj.put(SUMMARY_DATA_FIELD_LIST[SUMMARY_DATA_TXBYTESPERSECOND_INDEX], roundTo(getTxBytesPerSecond(), ROUND_TO_PLACES));
