...
public class GatewayConfigTranslatorFactory {
    ...
    private GatewayConfigTranslatorFactory() {
    }
    ...
    /**
     * Given an incoming namespace, return the translator pipeline to translate a document
     * with that namespace up to the 'current' format.
     * 
     * @param ns
     * @return
     */
