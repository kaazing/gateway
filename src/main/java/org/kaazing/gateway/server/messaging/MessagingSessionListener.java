 ...
 * TODO: may want to add acknowledge failed
 * 
 */
public interface MessagingSessionListener {
     ...
     * @param session
     */
    void sendFailed(int reason, String message, String destiantion, Map<String, Object> attributes, Object payload, MessagingSession session);
}
