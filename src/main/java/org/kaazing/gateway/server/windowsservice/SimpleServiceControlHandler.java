...
/**
 * Part of JNA-based Windows Service program, based on the example I found in
...
class SimpleServiceControlHandler implements HandlerEx {
	...
	/* (non-Javadoc)
	 * @see org.kaazing.gateway.server.windowsservice.ExtendedAdvapi32.HandlerEx#serviceControlHandler(int, int, com.sun.jna.Pointer, com.sun.jna.Pointer)
	 */
	@Override
