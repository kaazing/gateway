...
public class ParseTimeIntervalTest {
    ...
    public void testUnits() throws Exception {
        for ( TimeUnit timeUnitUnderTest: TimeUnit.values()) {
            ...
            for (String unit: units) {
                assertEquals("Expected 25 "+unit+" to convert to 25 "+timeUnitUnderTest.name(), 25, Utils.parseTimeInterval("25"+unit, timeUnitUnderTest, 0));
                assertEquals("Expected 25 "+unit.toUpperCase()+" to convert to 25 "+timeUnitUnderTest.name(), 25, Utils.parseTimeInterval("25"+unit.toUpperCase(), timeUnitUnderTest, 0));
            }
    ...
    @Test @Ignore // KG-6969: currently rounds down to 0
    ...
    @Test  (expected=NumberFormatException.class) 
    @Ignore // KG-6969: currently rounds down to 0. We should probable reject fractional milliseconds (e.g. with IllegalArgumentException).
