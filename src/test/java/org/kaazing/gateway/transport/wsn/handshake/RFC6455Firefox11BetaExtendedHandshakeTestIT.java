...
public class RFC6455Firefox11BetaExtendedHandshakeTestIT {
	...
	@Robotic(script = "canCompleteAnExtendedHandshakeFirstRequestAndNegotiateTheXKaazinghandshakeProtocol")
	@Test(timeout = 1500)
