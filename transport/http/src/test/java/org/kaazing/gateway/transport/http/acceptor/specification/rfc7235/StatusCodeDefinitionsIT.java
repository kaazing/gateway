...
public class StatusCodeDefinitionsIT {
    ...
    @Test
    @Specification({"multiple.requests.with.invalid.credentials/request"})
    ...
    @Test
    @Specification({"challenge.with.proxy.authorization.header/request"})
    ...
    @Test
    @Specification({"challenge.with.proxy.authenticate.header/request"})
