...
public class BasicHttpChallengeFactoryTest {
    ...
    public void canBuildASimpleChallenge() throws Exception {
        ...
        HttpResponseMessage response = factory.createChallenge(request, new HttpRealmConfig("demo", null, "Basic", "Realm Description", null,
    ...
    public void canBuildAnApplicationChallenge() throws Exception {
        ...
        HttpResponseMessage response = factory.createChallenge(request, new HttpRealmConfig("demo", null, "Application Basic", "Realm Description", null,
                new String[]{}, null, null, null));
        context.assertIsSatisfied();
        assertEquals(HttpStatus.CLIENT_UNAUTHORIZED, response.getStatus());
    ...
    public void canBuildAChallengeWhenAuthTypeIsNull() throws Exception {
        ...
        HttpResponseMessage response = factory.createChallenge(request, new HttpRealmConfig("demo", null, null, "Realm Description", null,
                new String[]{}, null, null, null));
        context.assertIsSatisfied();
        assertEquals(HttpStatus.CLIENT_UNAUTHORIZED, response.getStatus());
        assertEquals("Basic realm=\"Realm Description\"", response.getHeader("WWW-Authenticate"));
