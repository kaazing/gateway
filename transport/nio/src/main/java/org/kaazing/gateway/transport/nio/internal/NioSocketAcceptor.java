...
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.DEBUG_NIOWORKER_POOL;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_BACKLOG;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_IP_TOS;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_KEEP_ALIVE;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_MAXIMUM_READ_BUFFER_SIZE;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_MINIMUM_READ_BUFFER_SIZE;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_NO_DELAY;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_PROCESSOR_COUNT;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_READ_BUFFER_SIZE;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_RECEIVE_BUFFER_SIZE;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_REUSE_ADDRESS;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_SEND_BUFFER_SIZE;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_SO_LINGER;
import static org.kaazing.gateway.transport.nio.internal.NioSystemProperty.TCP_WRITE_TIMEOUT;
