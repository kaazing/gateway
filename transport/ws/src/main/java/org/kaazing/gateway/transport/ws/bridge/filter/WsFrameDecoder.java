...
public class WsFrameDecoder extends CumulativeProtocolDecoderEx {
    ...
    WsFrameDecoder(IoBufferAllocatorEx<?> allocator, int maxMessageSize, ActiveWebSocketExtensions extensions) {
        super(allocator);
    ...
    void setExtensions(ActiveWebSocketExtensions extensions) {
        if (extensions != null) {
    ...
    private static class ExtensionsBinaryTextMessageDecoder implements BinaryTextMessageDecoder{
        ...
        private ExtensionsBinaryTextMessageDecoder(ActiveWebSocketExtensions extensions) {
