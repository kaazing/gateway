...
public class WsebTextAsBinaryFrameEncoder extends WsebFrameEncoder {
    ...
    public WsebTextAsBinaryFrameEncoder(IoBufferAllocatorEx<?> allocator) {
        this(IO_MESSAGE_ENCODER, allocator);
    }

    public WsebTextAsBinaryFrameEncoder(CachingMessageEncoder cachingEncoder, IoBufferAllocatorEx<?> allocator) {
