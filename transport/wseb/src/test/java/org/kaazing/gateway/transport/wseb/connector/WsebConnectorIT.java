...
public class WsebConnectorIT {
    ...
    private final GatewayRule gateway = new GatewayRule() {
        {
            ...
            GatewayConfiguration configuration =
                    new GatewayConfigurationBuilder()
                        ...
                        .service()
                            .accept(URI.create("tcp://localhost:8010"))
                            .connect(URI.create("wse://localhost:8011/wse_backend"))
                            .type("proxy")
                        .done()
                    .done();
            // @formatter:on
            init(configuration, "log4j-diagnostic.properties");
        }
    };
    ...
    @Specification("shouldConnectSendAndReceive")
    @Test
    public void shouldConnectSendAndReceive() throws Exception {
        robot.finish();
    }
