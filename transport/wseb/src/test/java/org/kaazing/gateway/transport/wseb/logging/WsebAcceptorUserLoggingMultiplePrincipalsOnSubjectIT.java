...
/**
 * WsebAcceptorUserLoggingIT - verifies that if multiple instances of the nominated principal on the Subject,
 * only the first one will be used when writing to the log
 *
 ...
 */
public class WsebAcceptorUserLoggingMultiplePrincipalsOnSubjectIT {
    ...
    @Test
    public void verifyPrincipalNameLoggedWhenMultiplePrincipalsOnSubject() throws Exception {
        k3po.finish();
