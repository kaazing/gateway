...
public class TestLoginModule implements LoginModule {
    public static final String CLASS_NAME = TestLoginModule.class.getName();

    /**
     * The prefix that appears on all log output making it easier to identify.
     */
    public static final String LOG_PREFIX = "[TFL]";
    ...
    public boolean login() throws LoginException {
        ...
        if (!"Basic".equals(authScheme)) {
            ...
            logDebug("Expected authentication token scheme 'Basic', but received '" + authToken.getScheme()
                    + "'. Ignoring token");
            return false;
        }
    ...
    private String isTokenValid(String token) {
        // DPW TODO check if base64 encoded
