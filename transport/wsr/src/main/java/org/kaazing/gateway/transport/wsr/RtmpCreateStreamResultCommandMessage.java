...
public class RtmpCreateStreamResultCommandMessage extends RtmpCommandMessage {

	private static final String name = "_result";
	private double streamId;
	
	@Override
	public CommandKind getCommandKind() {
		return CommandKind.CREATE_STREAM_RESULT;
	}
